      ...
      },
      {
        ...
        hint: (
          <>
            ...
            taken with good resolution under enough lighting without filters. The submitted document
            must be in color and certified following the Certification Guideline.
          </>
        ),
      },
      {
    ...
    formFields: [
      ...
      },
      {
        ...
        options: [
          ...
          {
            label: 'Self-owned Property',
            value: 'Self-owned Property',
          },
          {
            label: 'Mortgaged Property',
            value: 'Mortgaged Property',
          },
          {
            label: 'Company-owned Property',
            value: 'Company-owned Property',
          },
          {
            label: 'Family Property',
            value: 'Family Property',
          },
        ],
      },
    ],
    ...
    formFields: [
      {
        ...
        hint: (
          <>
            ...
            <OnboardingLink link="https://drive.google.com/file/d/1i9DSqb45RKnKiK8e0P-RP8OOSFqDdj6t/view?usp=share_link">
              download
            </OnboardingLink>

...
const OnboardingSG = () => {
        ...
        <>
          {me?.__typename === 'CompanyUser' && (
            <>
              ...
              this application. I am fully aware that Aegis Custody Pte Ltd is authorized to supply
          ...
          {me?.__typename === 'IndividualUser' && (
            <>
              ...
              Custody Pte Ltd is authorized to supply any or all of such information to the
  ...
  const handleViewChecklist = () => {
    me?.__typename === 'CompanyUser' &&
      window.open(
        'https://drive.google.com/file/d/1udceI8gyW9q6A4KTPYNVaVThEJSzcVOX/view?usp=share_link',
        '_blank',
      )

    me?.__typename === 'IndividualUser' &&
      window.open(
        'https://drive.google.com/file/d/1ObQIT5hj3p3LQJnO1zHWeTFMCfwW4vcJ/view?usp=share_link',
        '_blank',
      )
  }
  ...
  return (
    <FormBox>
      ...
      <Typography variant="body2" color="text.primary">
        Aegis Custody Pte Ltd needs to seek and keep a certified copy (if applicable) of the
